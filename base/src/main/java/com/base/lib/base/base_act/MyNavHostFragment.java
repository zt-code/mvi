...
public class MyNavHostFragment extends Fragment implements NavHost {
    ...
    protected void onCreateNavController(@NonNull NavController navController) {
        ...
        navController.getNavigatorProvider().addNavigator(createMyFragmentNavigator());
    }

    // TODO: DialogMyFragmentNavigator should use FragmentOnAttachListener from Fragment 1.3
    @SuppressWarnings("deprecation")
    @Override
    public void onAttachFragment(@NonNull Fragment childFragment) {
        super.onAttachFragment(childFragment);
        DialogFragmentNavigator dialogMyFragmentNavigator =
                mNavController.getNavigatorProvider().getNavigator(DialogFragmentNavigator.class);
        dialogMyFragmentNavigator.onAttachFragment(childFragment);
    }
    ...
    /**
     * Create the MyFragmentNavigator that this NavHostFragment will use. By default, this uses
     * {@link-MyFragmentNavigator}, which replaces the entire contents of the NavHostFragment.
     * <p>
     * This is only called once in {@link #onCreate(Bundle)} and should not be called directly by
     * subclasses.
     * @return a new instance of a MyFragmentNavigator
     * @deprecated Use {@link #onCreateNavController(NavController)}
     */
    @SuppressWarnings("DeprecatedIsStillUsed")
    @Deprecated
    @NonNull
    protected Navigator<? extends MyFragmentNavigator.Destination> createMyFragmentNavigator() {
