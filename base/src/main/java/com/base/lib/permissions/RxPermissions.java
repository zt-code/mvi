package com.base.lib.permissions;
...
public class RxPermissions {
        ...
        return new ObservableTransformer<T, Boolean>() {
            ...
            public ObservableSource<Boolean> apply(Observable<T> o) {
                return request(o, permissions)
                        // Transform MyObservable<Permission> to MyObservable<Boolean>
    ...
    Observable<Permission> requestImplementation(final String... permissions) {
        ...
        // In case of multiple permissions, we create an MyObservable for each of them.
